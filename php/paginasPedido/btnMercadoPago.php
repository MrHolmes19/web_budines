...
// Datos para probar la funcionalidad del sistema
...
$preference->back_urls = array(
  "success" => "http://localhost/web_budines/php/paginasPedido/enviarPedido.php",
...
<!-- Parte visual del boton Pagar. No se llega a ver, porque este boton se activa al pulsar "Siguiente" en la pagina -->
